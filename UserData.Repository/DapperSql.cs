...
namespace UserData.Repository
{
    public class DapperSql
    {
        ...
        public const string GetSeatNo = "SELECT Seatno AS Seatno FROM PassengerTable WHERE TravelId=@travelid and IsPaid=1 and IsCanceled=0 ";
        public const string InsertPasengerDeatils = "INSERT INTO PassengerTable(UserId,TravelId,PassengerName,Age,Seatno,ReferenceId) VALUES(@userid,@travelid,@passengername,@age,@seatno,@referenceid)";
